...
const config: SiteConfig = {
  ...
  seo: {
    title: 'IM8 Discount Code 2026: Current Promo & Best Deal',
    description: 'Looking for an IM8 discount code? Check the current IM8 Health promo, first-order savings, subscription pricing and review notes before buying.',
  ...
  faq: [
    ...
    { question: 'Is IM8 better than AG1?', answer: 'It depends on your goal. Compare formula, taste, serving cost, reviews and what each product replaces in your routine before choosing.' },
